...
/* User: [CanIsr_0_BusOff, CanIsr_0_MB00To15, CanIsr_0_MB16To31, CounterIsr_OsCounter] */
...
#define OS_START_SEC_STACK_RUNTASK_OSCORE0_VAR_NOINIT_UNSPECIFIED
#include "Os_MemMap_Stacks.h" /* PRQA S 5087 */ /* MD_MSR_19.1 */

/* Shared Task stack: RunTask_OsCore0 */
/* User: [RunTask_OsCore0] */
OS_STACK_DECLARE(OsCfg_Stack_RunTask_OsCore0_Dyn, OS_CFG_SIZE_RUNTASK_OSCORE0_STACK);

#define OS_STOP_SEC_STACK_RUNTASK_OSCORE0_VAR_NOINIT_UNSPECIFIED
#include "Os_MemMap_Stacks.h" /* PRQA S 5087 */ /* MD_MSR_19.1 */
...
/*! Stack configuration data: RunTask_OsCore0 */
CONST(Os_StackConfigType, OS_CONST) OsCfg_Stack_RunTask_OsCore0 =
{
  /* .LowAddress  = */ OS_STACK_GETLOWADDRESS(OsCfg_Stack_RunTask_OsCore0_Dyn),
  /* .HighAddress = */ OS_STACK_GETHIGHADDRESS(OsCfg_Stack_RunTask_OsCore0_Dyn)
};
