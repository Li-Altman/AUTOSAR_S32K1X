 ...
 *   Generation Time: 2026-06-02 23:25:44
...
/*! Dynamic alarm data: Rte_Al_TE2_RunTask_OsCore0_0_10ms */
OS_LOCAL VAR(Os_AlarmType, OS_VAR_NOINIT) OsCfg_Alarm_Rte_Al_TE2_RunTask_OsCore0_0_10ms_Dyn;
...
/*! Dynamic alarm data: Rte_Al_TE_ECU_APPM_ECU_APPM_Runnable */
OS_LOCAL VAR(Os_AlarmType, OS_VAR_NOINIT) OsCfg_Alarm_Rte_Al_TE_ECU_APPM_ECU_APPM_Runnable_Dyn;
...
/*! Alarm configuration data: Rte_Al_TE2_RunTask_OsCore0_0_10ms */
CONST(Os_AlarmSetEventConfigType, OS_CONST) OsCfg_Alarm_Rte_Al_TE2_RunTask_OsCore0_0_10ms =
{
  /* .Alarm = */
  {
    /* .Job                   = */
    {
      /* .Dyn      = */ OS_ALARM_CASTDYN_ALARM_2_JOB(OsCfg_Alarm_Rte_Al_TE2_RunTask_OsCore0_0_10ms_Dyn),
  ...
  /* .Mask  = */ Rte_Ev_Cyclic2_RunTask_OsCore0_0_10ms
};

/*! Alarm configuration data: Rte_Al_TE2_RunTask_OsCore0_0_20ms */
CONST(Os_AlarmSetEventConfigType, OS_CONST) OsCfg_Alarm_Rte_Al_TE2_RunTask_OsCore0_0_20ms =
{
  /* .Alarm = */
  {
    /* .Job                   = */
    {
      /* .Dyn      = */ OS_ALARM_CASTDYN_ALARM_2_JOB(OsCfg_Alarm_Rte_Al_TE2_RunTask_OsCore0_0_20ms_Dyn),
      /* .Counter  = */ OS_COUNTER_CASTCONFIG_TIMERPIT_2_COUNTER(OsCfg_Counter_OsCounter),
      /* .Callback = */ Os_AlarmActionSetEvent
    },
    /* .Autostart             = */
...
/*! Alarm configuration data: Rte_Al_TE_ECU_APPM_ECU_APPM_Runnable */
CONST(Os_AlarmActivateTaskConfigType, OS_CONST) OsCfg_Alarm_Rte_Al_TE_ECU_APPM_ECU_APPM_Runnable =
{
  /* .Alarm = */
  {
    /* .Job                   = */
    {
      /* .Dyn      = */ OS_ALARM_CASTDYN_ALARM_2_JOB(OsCfg_Alarm_Rte_Al_TE_ECU_APPM_ECU_APPM_Runnable_Dyn),
      /* .Counter  = */ OS_COUNTER_CASTCONFIG_TIMERPIT_2_COUNTER(OsCfg_Counter_OsCounter),
  ...
  /* .Task  = */ &OsCfg_Task_OsTask_APP_10ms_1
};
...
CONSTP2CONST(Os_AlarmConfigType, OS_CONST, OS_CONST) OsCfg_AlarmRefs[OS_ALARMID_COUNT + 1] =
{
  ...
  OS_ALARM_CASTCONFIG_ALARMACTIVATETASK_2_ALARM(OsCfg_Alarm_Rte_Al_TE_ECU_APPM_ECU_APPM_Runnable),
  NULL_PTR
};
