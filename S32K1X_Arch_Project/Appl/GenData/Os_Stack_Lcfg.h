...
extern OS_STACK_DECLARE(OsCfg_Stack_RunTask_OsCore0_Dyn, OS_CFG_SIZE_RUNTASK_OSCORE0_STACK);
...
extern CONST(Os_StackConfigType, OS_CONST) OsCfg_Stack_RunTask_OsCore0;
