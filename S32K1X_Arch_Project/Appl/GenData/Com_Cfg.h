...
#define ComConf_ComSignal_Sig_Light_1_Ctrl_oGateway_1_oN_CAN1_1104c004_Rx 0u
/**\} */
...
/* Handle IDs active in all predefined variants (the application has not to take the active variant into account) */
/*      Symbolic Name                                                 Value   Active in predefined variant(s) */
#define ComConf_ComSignal_Sig_Light_1_Sts_oBCM1_1_oN_CAN1_e6c4aa46_Tx 0u
/**\} */
...
/* Handle IDs active in all predefined variants (the application has not to take the active variant into account) */
/*      Symbolic Name                                                 Value   Active in predefined variant(s) */
#define ComConf_ComIPduGroup_BCM_oN_CAN1_Rx_c4dc8d2f                  0u
#define ComConf_ComIPduGroup_BCM_oN_CAN1_Tx_92862aa9                  1u
/**\} */
...
#define Com_GetSizeOfRxAccessInfoIndOfPCConfig()                      1u  /**< the number of accomplishable value elements in Com_RxAccessInfoInd */
#define Com_GetSizeOfRxAccessInfoOfPCConfig()                         1u  /**< the number of accomplishable value elements in Com_RxAccessInfo */
...
#define Com_GetSizeOfRxSigBufferUInt8OfPCConfig()                     1u  /**< the number of accomplishable value elements in Com_RxSigBufferUInt8 */
...
#define Com_GetApplTypeOfRxAccessInfo(Index)                          ((Com_ApplTypeOfRxAccessInfoType)((Index)))  /**< Application data type. */
#define Com_GetBitLengthOfRxAccessInfo(Index)                         ((Com_BitLengthOfRxAccessInfoType)((((Com_BitLengthOfRxAccessInfoType)(Index)) + 8u)))  /**< Bit length of the signal or group signal. */
...
#define Com_GetBusAccOfRxAccessInfo(Index)                            ((Com_BusAccOfRxAccessInfoType)((((Com_BusAccOfRxAccessInfoType)(Index)) + 0x01u)))  /**< BUS access algorithm for signal or group signal packing / un-packing. */
#define Com_GetByteLengthOfRxAccessInfo(Index)                        ((Com_ByteLengthOfRxAccessInfoType)((((Com_ByteLengthOfRxAccessInfoType)(Index)) + 1u)))  /**< Byte length of the signal or group signal. */
...
#define Com_GetInitValueIdxOfRxAccessInfo(Index)                      ((Com_InitValueIdxOfRxAccessInfoType)((Index)))  /**< the index of the 0:1 relation pointing to Com_ConstValueUInt8,Com_ConstValueUInt16,Com_ConstValueUInt32,Com_ConstValueUInt64,Com_ConstValueSInt8,Com_ConstValueSInt16,Com_ConstValueSInt32,Com_ConstValueSInt64,Com_ConstValueFloat32,Com_ConstValueFloat64 */
#define Com_GetRxPduInfoIdxOfRxAccessInfo(Index)                      ((Com_RxPduInfoIdxOfRxAccessInfoType)((Index)))  /**< the index of the 1:1 relation pointing to Com_RxPduInfo */
...
#define Com_GetPduGrpVectorEndIdxOfTxPduGrpInfo(Index)                ((Com_PduGrpVectorEndIdxOfTxPduGrpInfoType)((((Com_PduGrpVectorEndIdxOfTxPduGrpInfoType)(Index)) + 2u)))  /**< the end index of the 0:n relation pointing to Com_PduGrpVector */
#define Com_GetPduGrpVectorStartIdxOfTxPduGrpInfo(Index)              ((Com_PduGrpVectorStartIdxOfTxPduGrpInfoType)((((Com_PduGrpVectorStartIdxOfTxPduGrpInfoType)(Index)) + 1u)))  /**< the start index of the 0:n relation pointing to Com_PduGrpVector */
...
{
  Com_HandleRxPduDeferredType Gateway_1_oN_CAN1_a41891bf_Rx;
...
{
  Com_RxDefPduBufferType Gateway_1_oN_CAN1_a41891bf_Rx[8];
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
extern CONST(Com_RxAccessInfoType, COM_CONST) Com_RxAccessInfo[1];
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
extern VAR(Com_RxSigBufferUInt8Type, COM_VAR_NOINIT) Com_RxSigBufferUInt8[1];
#define COM_STOP_SEC_VAR_NOINIT_8BIT
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
